...
type
  ...
  ITextRange = interface(IDispatch)
    ...
    function Get_RangeStart: Integer; safecall;
    procedure Set_RangeStart(pcpFirst: Integer); safecall;
    function Get_RangeEnd: Integer; safecall;
    procedure Set_RangeEnd(pcpLim: Integer); safecall;
    ...
    property RangeStart: Integer read Get_RangeStart write Set_RangeStart;
    property RangeEnd: Integer read Get_RangeEnd write Set_RangeEnd;
  ...
  ITextFont = interface(IDispatch)
    ...
    function Get_Protected: Integer; safecall;
    procedure Set_Protected(pValue: Integer); safecall;
    ...
    property Protected: Integer read Get_Protected write Set_Protected;
